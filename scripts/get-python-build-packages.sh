...
DEBIAN_9_PKGS="bash curl libbz2-dev libffi-dev libgdbm-dev libncurses5-dev \
libncursesw5-dev libpython3-dev libreadline-dev libsqlite3-dev libssl1.0-dev \
libxml2-dev liblzma-dev llvm make uuid-dev xz-utils zlib1g-dev"
