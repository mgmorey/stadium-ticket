...
class TestValidateFunctions(unittest.TestCase):
    ...
    def test_validate_dialect_pass(self):
        value = validate_string('DATABASE_DIALECT', 'mysql')
    ...
    def test_validate_host_pass(self):
        value = validate_string('DATABASE_HOST', 'localhost')
    ...
    def test_validate_password_pass(self):
        value = validate_string('DATABASE_PASSWORD', 'Hello!')
    ...
    def test_validate_schema_pass(self):
        value = validate_string('DATABASE_SCHEMA', 'my-database-schema')
    ...
    def test_validate_user_pass(self):
        value = validate_string('DATABASE_USER', 'root')
